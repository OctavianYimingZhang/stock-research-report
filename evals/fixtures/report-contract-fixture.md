# Calibration Target Deep Research Report
## Re-rating dispute placeholder

## Core Conclusion

The current investment dispute is whether verified demand can convert into
earnings before the current price fully discounts the ramp. Revenue was 100 in
...
external thesis as context only and tests it against primary sources. Demand
expansion is linked to identified customer spending, and the report separates a
structural demand driver from a cyclical rebound.
...
The old value driver was cyclical unit volume, while the new value driver is
higher-value demand tied to a verified capacity bottleneck. The report separates
verified fact from inference and names one verification variable.

## Scarcity And Moat Assessment

Technical, capacity, certification, customer relationship, geographic, and
policy scarcity are tested before the report assigns moat value. Replication
difficulty is stated as an evidence-backed claim or blocked.

## Customers, Orders, And Commercialization Path

Commercialization visibility is graded through recognized revenue, binding
contract evidence, purchase obligation disclosure, and weaker pipeline language.
Backlog is not treated as profit. The order-to-revenue bridge links delivery
